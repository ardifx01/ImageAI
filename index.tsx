...
const styles = [
    ...
    { name: 'Vintage 1990s analog film camera', prompt: 'A cinematic, candid, and expressive photograph with strong low-lighting and motion blur, taken with a vintage 1990s analog film camera. The subject is a person (use the uploaded face photo with 100% likeness and realistic details, and use the uploaded clothing exactly as in the photo) glancing at the viewer, their face highlighted by sharp, dramatic lighting. The facial expression is slightly blurred, adding a sense of movement and realism. The effect of motion dominates the image: strong blur on the arms and surroundings, creating a fleeting sense of movement. The background is softened with thick bokeh that isolates the subject’s face as the focal point. The film’s texture is rich with subtle, soft, and organic analog grain, evoking the authentic look of 1990s photography. The retro feel is enhanced by soft green-yellow tints, subtle scratches, and faint light leaks, while digital noise has been removed to maintain clarity. The scene is set indoors, with subtle, blurry elements in the background. A dark panel or door with the faint inscription “Mall Indonesia” is visible on the right, adding to the mysterious, documentary-like atmosphere. The overall composition blends cinematic depth with honest naturalism. {prompt}', singleUploader: true, placeholder: 'Tambahkan detail kecil jika diinginkan...' },
    { name: 'Realistic BW portrait', prompt: 'A realistic black-and-white portrait of the uploaded person, sitting casually on the floor near a plain wall. The subject is slightly turning their head towards the light source, allowing the face to be partially illuminated while leaving soft shadows across the other side. Strong, directional natural light enters from a window, casting sharp geometric patterns of light and shadow on the wall and floor. The mood is contemplative and expressive, with a minimalist, cinematic atmosphere. {prompt}', singleUploader: true, placeholder: 'Tambahkan detail kecil jika diinginkan...' },
    { name: 'Cinematic reflective', prompt: 'A cinematic, reflective portrait of a person (use the uploaded face photo with 100% likeness and realistic detail, and keep the clothing exactly as in the uploaded photo) standing in a deep shadowed void. The background is completely dark and minimal, creating a dramatic and moody atmosphere. A single beam of warm amber light brushes across the face, casting sharp highlights and deep shadows, while leaving most of the surroundings in darkness. The mood conveys solitude, contemplation, and inner calm, with a high-contrast, cinematic, and dramatic composition. {prompt}', singleUploader: true, placeholder: 'Tambahkan detail kecil jika diinginkan...' },
    { name: 'Casual office outfit', prompt: 'A high-resolution, full-body studio portrait of a person (use the uploaded face photo with 100% resemblance and realistic detail). The person is wearing a modern casual office outfit suitable for professional settings. For men, this means a smart-casual button-up shirt or blazer with chinos or dress pants, paired with polished casual shoes. For women, this means a smart-casual blouse, blazer, or an elegant dress with office shoes or heels. The outfit must look natural, well-fitted, and professional yet approachable. The composition shows the entire body from head to toe, including the shoes. The background is a clean, minimalist studio setup with soft gradient lighting that enhances the subject’s form. The lighting is cinematic and professional, with sharp focus and natural skin tones. The overall style resembles a modern corporate or business portrait used for professional profiles, resumes, and company branding. Ultra sharp, photorealistic, stylish, and polished. {prompt}', singleUploader: true, placeholder: 'Tambahkan detail kecil jika diinginkan...' },
    { name: 'Casual Hangout Outfit', prompt: 'A high-resolution, full-body studio portrait of a person (use the uploaded face photo with 100% resemblance and realistic detail). The person is wearing a casual, stylish outfit suitable for hanging out or social gatherings. For men, this could be a fitted t-shirt or casual shirt with jeans or chinos, paired with sneakers or casual shoes. For women, this could be a casual top or t-shirt with jeans, skirt, or relaxed pants, paired with sneakers, sandals, or casual shoes. The outfit must look trendy, comfortable, and natural, reflecting a relaxed hangout style. The composition shows the entire body from head to toe, including the shoes. The background is a clean, minimalist studio setup with soft gradient lighting that emphasizes the subject. The lighting is cinematic and professional, with sharp focus and natural tones. The overall style is modern, youthful, and photorealistic — resembling a lifestyle fashion studio photo used for casual branding or social media. {prompt}', singleUploader: true, placeholder: 'Tambahkan detail kecil jika diinginkan...' },
    { name: 'Candid street-style', prompt: 'A high-resolution, full-body street-style photograph of one or more people (use the uploaded face photo(s) with 100% resemblance and realistic detail). They are casually posing or standing in front of a stylish café or coffee shop, some holding takeaway coffee cups.\n\nOutfits are casual and modern: for men, options include fitted t-shirts, casual shirts, or light jackets with jeans or chinos, paired with sneakers or loafers. For women without hijab, options include casual tops, blouses, or dresses with jeans, skirts, or trousers, paired with flats or sneakers. For women with hijab, use trendy and modern hijab fashion, such as a long outer with jeans, a tunic with wide-leg pants, or a modest blouse with tailored trousers, paired with sneakers or ankle boots.\n\nThe composition shows full-body views from head to toe, including shoes. The café background features windows, signage, warm sunlight, and an urban street vibe, creating a lifestyle, photorealistic, and aesthetic atmosphere — like a candid social media or fashion photography shot. {prompt}', singleUploader: true, placeholder: 'Tambahkan detail kecil jika diinginkan...' },
];
