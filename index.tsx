...
const styles = [
    ...
    { name: 'Pose Bersama', prompt: 'Gabungkan orang dari kedua gambar ini ke dalam satu foto. Pastikan keduanya terlihat berpose bersama secara alami di latar belakang studio yang netral. Sangat penting untuk mempertahankan kemiripan wajah 100% untuk kedua orang tersebut. {prompt}', singleUploader: false, placeholder: 'Tambahkan detail, mis: di taman kota, gaya kasual...' },
];
